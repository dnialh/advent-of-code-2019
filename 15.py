...
while queue:
    ...
    for i in range(4):
        change = directions[i]
        att = (nex[0] + change[0], nex[1] + change[1])
        #print(nex, att)

        if att in tiles:
            continue

        moves = tiles[nex][0] + [i + 1]
        inp = [i + 1]
        l = tiles[nex][1][:]
